...
export default function Movie({title, releaseDate, averageRating, posterImage, displayMovie, id}) {
    ...
    return(
        <div className="poster-container">
            ...
            <button className="on-image" onClick={toggleLikeButton}>
                {!isLiked ? (
                <svg className="heart on-image" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
